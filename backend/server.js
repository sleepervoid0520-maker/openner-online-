...
const io = socketIO(server, {
  cors: {
    origin: [FRONTEND_URL, 'http://localhost:3000', 'http://127.0.0.1:3000', 'http://104.248.214.10:3000', 'https://opennergame.duckdns.org'],
    credentials: true
  }
});
...
app.use(helmet({
  ...
  connectSrc: ["'self'", 'http://104.248.214.10:3000', 'https://opennergame.duckdns.org']
    }
  }
}));
